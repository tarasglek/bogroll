...
" in
  let ls = List.map (function (title, body) -> [Element( "h3", [], [Xml.PCData title]); 
  ...
  let e = 
    Element ("html", [("xmlns", "http://www.w3.org/1999/xhtml"); ("xml:lang", "en")], [
               Element ("head", [], [
                          Element ("title", [], [Xml.PCData "some title"]);
                          Element ("meta", ["http-equiv","Content-Type";"content","application/xhtml+xml; charset=utf-8"], []);
                          Element ("meta", ["name","EPB-UUID"; "content","753C90B5-6C08-1014-A044-DC40CEEA30C3"], [])
                        ]);
               Element ("body", [], List.flatten ls)]
            ) in
